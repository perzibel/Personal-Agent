...
IDS_FOLDER = os.getenv("GOOGLE_DRIVE_IDS_FOLDER")
FAMILY_FOLDER = os.getenv("GOOGLE_DRIVE_FAMILY_FOLDER")
HOME_FOLDER = os.getenv("GOOGLE_DRIVE_HOME_FOLDER")
CARS_FOLDER = os.getenv("GOOGLE_DRIVE_CARS_FOLDER")
WORK_FOLDER = os.getenv("GOOGLE_DRIVE_WORK_FOLDER")
